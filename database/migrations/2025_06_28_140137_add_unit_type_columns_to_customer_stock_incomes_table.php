...
return new class extends Migration
{
    ...
    {
        Schema::table('customer_stock_incomes', function (Blueprint $table) {
            $table->enum('unit_type', ['retail', 'wholesale'])->default('retail')->after('total');
            ...
            $table->text('notes')->nullable()->after('unit_name');
        });
    }
    ...
    {
        Schema::table('customer_stock_incomes', function (Blueprint $table) {
            $table->dropColumn(['unit_type', 'is_wholesale', 'unit_id', 'unit_amount', 'unit_name', 'notes']);
        });
    }
};
