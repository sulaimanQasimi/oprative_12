...
class EditAddress extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'account::pages.edit-address';
    ...
    {
        return  trans('account::messages.address.title');
    }

    public static function getNavigationLabel(): string
    {
        return trans('account::messages.address.title'); // TODO: Change the autogenerated stub
    }

    public function table(Table $table): Table
    {
        return $table
            ->query(Location::query()->where('model_id', auth('accounts')->user()->id)->where('model_type',config('account.model')))
            ->columns([
