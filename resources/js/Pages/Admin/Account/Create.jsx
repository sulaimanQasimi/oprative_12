...
import { Save, ArrowLeft, CreditCard, MapPin, AlertCircle } from 'lucide-react';
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                ...
                                <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">{t("Create New Account")}</h1>
                            </div>
                        </div>
                    </motion.header>
