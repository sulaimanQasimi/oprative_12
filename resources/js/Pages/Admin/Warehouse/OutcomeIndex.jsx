...
export default function OutcomeIndex({ auth, outcomes = [], pagination = {}, filters = {}, availableWarehouses = [], availableProducts = [], stats = {} }) {
    ...
    const handleFilter = () => {
        ...
        router.get(route('admin.outcomes.index'), params, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <>
            ...
            <div className="flex h-screen bg-gradient-to-br from-slate-50 via-red-50 to-orange-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 overflow-hidden">
