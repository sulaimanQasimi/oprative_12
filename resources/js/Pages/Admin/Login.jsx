            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="w-full max-w-md p-8 bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 relative">
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-white mb-2">{t('Admin Portal')}</h2>
                        <p className="text-gray-300">{t('Access the administrative dashboard')}</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-left"
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-400 text-sm">
                            {t('Secure administrative access')}
                        </p>
                    </div>
                </div>
            </div>
