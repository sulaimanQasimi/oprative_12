...
export default function Inventory({ auth, customer, products }) {
    ...
    return (
        <>
            <Head title={`${customer?.name} - ${t("Inventory")}`}>
                <style>{`
                    @keyframes shimmer {
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    >
                                        {customer?.name} - {t("Inventory Management")}
                                    </motion.p>
                                    <motion.h1
                                        initial={{ x: -20, opacity: 0 }}
                                        animate={{ x: 0, opacity: 1 }}
                                ...
                                <Card className="border-0 shadow-xl bg-white/70 dark:bg-slate-700/70 backdrop-blur-sm">
                                    <CardHeader className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border-b border-white/20 dark:border-slate-600/50">
                                        ...
                                        <CardDescription className="text-slate-600 dark:text-slate-400">
                                            {t("Complete list of products in customer inventory")}
                                        </CardDescription>
                                    </CardHeader>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-slate-600 dark:text-slate-400">
                                                            {searchTerm 
                                                                ...
                                                                : t("This customer doesn't have any products in inventory yet")
                                                            }
                                                        </p>
                                                    </div>
                                                </div>
