                                                            ...
                                                            <Alert className="border-green-200 bg-green-50 dark:bg-green-900/20">
                                                                ...
                                                                <AlertDescription className="text-green-700 dark:text-green-400 font-medium">
                                                                    ...
                                                                    <div className="space-y-1">
                                                                        <p className="text-xs">
                                                                            <strong>{t("Input")}:</strong><span dir="ltr"> {data.quantity} × {formatCurrency(data.price)} = {formatCurrency(data.quantity * data.price)}</span>
                                                                        </p>
                                                                        {data.unit_amount > 1 && (
                                                                            <p className="text-xs">
                                                                                <strong>{t("Database")}:</strong> <span dir="ltr"> {data.quantity} × {data.unit_amount} = {calculatedQuantity} {units?.find(u => u.id.toString() === data.unit_id)?.code || selectedProduct?.unit?.code || 'units'}</span>
                                                                            </p>
                                                                        )}
                                                                        <p className="text-xs">
