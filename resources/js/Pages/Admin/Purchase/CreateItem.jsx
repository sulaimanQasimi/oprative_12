                                        ...
                                        <div key={step} className="flex items-center">
                                            <div className={`flex items-center justify-center w-12 h-12 rounded-full border-2 transition-all duration-300 ${
                                                ...
                                                {step < currentStep ? (
                                                    ...
                                                    React.createElement(stepIcons[step - 1], { className: "w-6 h-6" })
                                                )}
                                            </div>
                                            <div className="ml-3">
                                                <p className={`text-sm font-semibold ${step === currentStep ? 'text-green-600' : step < currentStep ? 'text-green-600' : 'text-gray-400'}`}>
                                                    {stepTitles[step - 1]}
                                                </p>
                                            </div>
                                            {step < 2 && (
