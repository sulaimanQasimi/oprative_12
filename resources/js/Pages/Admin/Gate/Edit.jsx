...
export default function Edit({ auth, gate, users = [], permissions = {} }) {
    ...
    const { data, setData, put, processing, errors, reset } = useForm({
        name: gate.name || "",
        user_id: gate.user_id ? gate.user_id.toString() : "",
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("admin.gates.update", gate.id));
    };

    return (
        <>
            <Head title={`${t("Edit Gate")} - ${gate.name}`}>
                <style>{`
                    @keyframes shimmer {
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {t("Update gate information and assignments")}
                                    </motion.p>
                                </div>
                            </div>
