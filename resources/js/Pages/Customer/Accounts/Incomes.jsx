...
export default function Incomes({ auth, account, incomes, outcomes, totalIncome, pendingIncome,
                                        ...
                                        <div>
                                            ...
                                            <div className="relative rounded-lg shadow-sm">
                                                ...
                                                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                    <span className="text-gray-500 sm:text-sm">AFN</span>
                                                </div>
                                            </div>
                                            {errors.amount && (
