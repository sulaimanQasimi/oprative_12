...
const OutcomeRow = memo(({ record, index, t, onSort, sortBy, sortOrder }) => (
    <motion.tr
    ...
    >
        ...
        <td className="px-6 py-4 whitespace-nowrap text-center">
            {record.batch ? (
                <div className="p-3 rounded-xl bg-gradient-to-r from-rose-50/70 to-red-50/70 dark:from-rose-900/30 dark:to-red-900/30 border border-rose-200/30 dark:border-rose-800/30">
...
export default function Outcome({ auth, outcome, pagination, filters }) {
    ...
    const handleFilter = useCallback(() => {
        router.get(route('warehouse.outcome'), filterParams, {
            preserveState: true,
            preserveScroll: true,
        });
    }, [filterParams]);
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <motion.h1
                                        ...
                                        className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-rose-600 via-red-600 to-rose-700 bg-clip-text text-transparent"
                                    >
                                        {t("Export Product")}
                                    </motion.h1>
                                    <motion.p
