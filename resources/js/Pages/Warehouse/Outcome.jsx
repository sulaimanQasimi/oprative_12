                ...
                <div className="grid grid-cols-12 min-h-screen">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 bg-gray-50 dark:bg-gray-900">
                            ...
                            <div className="space-y-4">
                                {filteredOutcome && filteredOutcome.length > 0 ? (
                                    filteredOutcome.map(record => (
                                        <Card key={record.id} className="shadow-sm border-none">
                                            <CardContent className="p-4">
                                                <div className="flex items-center space-x-4">
                                                    <div className="h-12 w-12 bg-red-100 dark:bg-red-900/30 rounded-lg flex items-center justify-center text-red-600">
                                                        <TrendingUp className="h-6 w-6 rotate-180" />
                                                    </div>
                                    ...
                                    <div className="text-center py-12">
                                        <TrendingUp className="h-12 w-12 mx-auto text-gray-400 mb-4 rotate-180" />
                                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">No outcome transactions found</h3>
                                        <p className="text-gray-500">
                                            {searchTerm ? 'Try adjusting your search criteria' : 'Add outcome transactions to track your outgoing inventory'}
                                        </p>
                    ...
                    <div className="col-span-3 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700">
                        ...
                        <div className="p-4 border-t border-gray-200 dark:border-gray-700 mt-4">
                            <h2 className="font-semibold text-xl mb-4">Outcome Statistics</h2>
                                ...
                                <CardContent className="p-4">
                                    ...
                                    {outcome && outcome.length > 0 ? (
                                        <div className="space-y-2">
                                            {Array.from(new Set(outcome.map(o => o.destination))).slice(0, 5).map((destination, index) => (
                                                <div key={index} className="flex items-center justify-between">
                                                    <span className="text-sm">{destination}</span>
                                                    <span className="text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded-full">
                                                        ${outcome.filter(o => o.destination === destination)
                                    ...
                                    <div className="grid grid-cols-3 gap-2 text-center">
                                        <div className="p-2 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                            ...
                                            <p className="font-semibold text-red-600">
                                                ...
                                                }).reduce((sum, o) => sum + o.amount, 0).toFixed(2) || '0.00'}
                                            </p>
                                        </div>
                                        <div className="p-2 bg-gray-50 dark:bg-gray-700 rounded-lg">
