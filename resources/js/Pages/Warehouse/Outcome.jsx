...
export default function Outcome({ auth, outcome }) {
    ...
    const totalOutcomeValue =
        outcome?.reduce((sum, record) => sum + record.amount, 0) || 0;

    // Calculate this month's outcome
    const thisMonthOutcome =
        outcome
            ?.filter((i) => {
    ...
    const outcomeChangePercent = lastMonthOutcome
        ? ((thisMonthOutcome - lastMonthOutcome) / lastMonthOutcome) * 100
        : 0;
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="relative flex flex-col">
                                ...
                                <h1 className="text-2xl font-bold text-slate-800 dark:text-white flex items-center gap-2">
                                    ...
                                    <Badge
                                        variant="outline"
                                        className="ml-2 bg-rose-50 text-rose-700 border-rose-200 dark:bg-rose-900/30 dark:text-rose-400 dark:border-rose-800 rounded-full"
                                    >
                                        {outcome?.length || 0}
                                    </Badge>
                                </h1>
                    ...
                    <main className="flex-1 overflow-auto scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700 scrollbar-track-transparent">
                        ...
                        <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 p-6 relative flex-shrink-0">
                            ...
                            <div
                                className="absolute right-20 top-10 w-72 h-72 bg-red-200/20 dark:bg-red-900/10 rounded-full filter blur-3xl animate-pulse"
                                style={{ animationDuration: "15s" }}
                            ></div>
                            <div
                                className="absolute -right-40 -bottom-40 w-80 h-80 bg-pink-200/20 dark:bg-pink-900/10 rounded-full filter blur-3xl animate-pulse"
                                style={{
                            ...
                            ></div>
                            <div
                                className="absolute left-1/3 bottom-0 w-64 h-64 bg-orange-200/20 dark:bg-orange-900/10 rounded-full filter blur-3xl animate-pulse"
                                style={{
                                                                ...
                                                                <div className="flex gap-1">
                                                                    ...
                                                                    >
                                                                        <Button
                                                                            variant="default"
                                                                            size="sm"
                                                                            className="bg-rose-500 hover:bg-rose-600 text-white rounded-lg h-8"
                                                                        >
                                                                            Details
                                                                        </Button>
                                                                    </Link>
                                ...
                                <div className="xl:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            <thead>
                                                <tr>
                                                    <th className="px-4 py-3 bg-gray-50 dark:bg-gray-800 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-16">
                                                        ID
                                                    </th>
                                                    ...
                                                    <th className="px-4 py-3 bg-gray-50 dark:bg-gray-800 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-24">
                                                        Actions
                                                    </th>
                                                </tr>
                                            </thead>
                                                ...
                                                outcome.length > 0 ? (
                                                    outcome
                                                        ...
                                                        .map((record) => (
                                                            ...
                                                            >
                                                                <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300 bg-white dark:bg-gray-800">
                                                                    {record.id}
                                                                </td>
                                                                ...
                                                                <td className="px-4 py-3 whitespace-nowrap text-right text-sm font-medium bg-white dark:bg-gray-800">
                                                                    <div className="flex items-center justify-end space-x-2">
                                                                        <Button
                                                                            variant="ghost"
                                                                            size="sm"
                                                                            className="h-8 w-8 p-0 text-gray-500 dark:text-gray-300"
                                                                        >
                                                                            <MoreHorizontal className="h-4 w-4" />
                                                                        </Button>
                                                                        <Button
                                                                            variant="outline"
                                                                            size="sm"
                                                                            className="h-8 text-red-600 dark:text-red-300 border-red-200 dark:border-red-800 hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-900/20 dark:hover:text-red-200 hover:border-red-300"
                                                                        >
                                                                            View
                                                                        </Button>
                                                                    </div>
                                    ...
                                    {outcome && outcome.length > 10 && (
                                        <div className="p-4 flex justify-center">
                                            <Button
                                                variant="outline"
                                                size="sm"
                                                className="text-red-600 dark:text-red-300 border-red-200 dark:border-red-800 hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-900/20 dark:hover:text-red-200 hover:border-red-300"
                                            >
