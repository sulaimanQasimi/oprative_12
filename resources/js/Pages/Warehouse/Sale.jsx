                                    ...
                                    {filteredSales && filteredSales.length > 0 ? (
                                                    ...
                                                    >
                                                        <div className="flex justify-between items-start p-5 pb-3">
                                                            <div className="flex gap-3 items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-sm text-slate-500 dark:text-slate-400">{record.customer}</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <CardFooter className="px-5 py-3 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex justify-between">
                                                            ...
                                                            <div className="flex gap-1">
                                                                ...
                                                                <Link href={route('warehouse.sales.show', record.id)}>
                                        ...
                                        >
                                            ...
                                            <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6">
                                                {searchTerm ? 'Try adjusting your search criteria or check for typos.' : 'No sales transactions have been recorded yet. Add your first transaction to get started.'}
                                            </p>
