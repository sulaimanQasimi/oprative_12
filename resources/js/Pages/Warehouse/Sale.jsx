...
import { Search, ShoppingCart, ChevronRight, Plus, Filter, ArrowUpRight, ArrowDownRight, BarChart3, Calendar, Clock, Download, MoreHorizontal, ExternalLink, Tag, User } from 'lucide-react';
            ...
            <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <header ref={headerRef} className="bg-white dark:bg-gray-800 shadow-sm p-4 flex items-center justify-between relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 opacity-50"></div>
                        ...
                        <div className="flex items-center space-x-3 relative z-10">
                            ...
                            <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-800 ml-2 px-2.5 py-0.5 rounded-full font-medium">
                        ...
                        <div className="relative z-10 flex space-x-2">
                            ...
                            <Button size="sm" className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white shadow-sm">
                                ...
                                <div className="relative w-full group">
                                    ...
                                    <div className="relative flex">
                                        ...
                                        <input
                                            ...
                                            className="flex-1 py-3 pl-11 pr-4 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                            value={searchTerm}
                            ...
                            <TabsContent value="grid" activeValue={view} className="mt-0">
                                {filteredSales && filteredSales.length > 0 ? (
                                    ...
                                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-10 text-center">
                                        ...
                                        <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">No sales found</h3>
