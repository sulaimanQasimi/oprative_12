...
export default function Income({ auth, income }) {
    ...
    const totalIncomeValue =
        income?.reduce((sum, record) => sum + record.amount, 0) || 0;
                                        ...
                                        >
                                            ...
                                            <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto mb-6">
                                                {searchTerm
                                                    ...
                                                    : t(
                                                          "No income transactions have been recorded yet. Add your first transaction to get started."
                                                      )}
                                            </p>
