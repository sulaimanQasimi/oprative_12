    ...
    return (
        <div className="flex min-h-screen overflow-hidden">
            ...
            <div className="flex flex-col justify-center flex-1 w-full px-6 py-12 mx-auto lg:px-8" dir="rtl">
                <Head title={t("Warehouse Login")} />
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm md:max-w-md lg:max-w-lg flex flex-col items-center">
                    {/* Logo and title */}
                    <div className="flex flex-col items-center mb-8">
                        <div className="mb-5 p-3 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-lg shadow-emerald-500/20">
                            <BarChart3 className="h-10 w-10 text-white" />
                        </div>
                        <h2 className="text-3xl font-bold text-center text-gray-900">
                            {t("Welcome to Warehouse Management")}
                        </h2>
                        <p className="mt-2 text-center text-gray-600">
                            {t("Login to access your dashboard")}
                        </p>
                    </div>
                        ...
                        {verificationStep > 0 ? (
                            ...
                            <form ref={formRef} className="space-y-6" onSubmit={handleSubmit}>
                                <div>
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="block w-full rounded-md border-0 py-3 pl-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6"
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="block w-full rounded-md border-0 py-3 pl-10 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6"
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className={`flex w-full justify-center items-center gap-2 rounded-md bg-gradient-to-r from-emerald-500 to-teal-600 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-sm hover:from-emerald-600 hover:to-teal-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600 transition-all duration-300 ${processing ? 'opacity-70 cursor-not-allowed' : ''}`}
                                        disabled={processing}
                                    >
                                        {processing ? (
                                            <>
                    ...
                    <div className="mt-8 text-center text-gray-500 text-sm">
                        ...
                        <p>
                            {t("© 2023 Warehouse Management System. All rights reserved.")}
                        </p>
                    </div>
                </div>
            </div>
