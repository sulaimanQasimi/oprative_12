                ...
                <div class="group relative transform transition-all duration-200 hover:-translate-y-0.5">
                    ...
                    <div class="relative bg-white/90 p-5 rounded-xl shadow-sm border border-gray-100">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="flex items-center gap-2 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl px-3 py-1.5 border border-gray-200/50 shadow-sm group">
                                    <button wire:click="updateQuantity({{ $index }}, -1)"
                                        class="text-gray-500 hover:text-green-600 w-7 h-7 flex items-center justify-center rounded-lg hover:bg-green-50/80 transition-all duration-300 hover:shadow-sm group-hover:shadow-md">
                                    ...
                                    <span class="text-base font-semibold w-8 text-center text-gray-700 bg-white/80 px-2 py-1 rounded-lg shadow-sm">{{ $item['quantity'] }}</span>
                                    <button wire:click="updateQuantity({{ $index }}, 1)"
                                        class="text-gray-500 hover:text-green-600 w-7 h-7 flex items-center justify-center rounded-lg hover:bg-green-50/80 transition-all duration-300 hover:shadow-sm group-hover:shadow-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transform group-hover:translate-y-0.5 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <button wire:click="removeItem({{ $index }})"
                                    class="text-gray-400 hover:text-red-500 p-2.5 rounded-xl hover:bg-red-50/80 transition-all duration-300 hover:shadow-sm group-hover:shadow-md transform hover:-translate-y-0.5">
