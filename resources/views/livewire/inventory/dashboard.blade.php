                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <div class="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-xl border border-green-100">
                                    ...
                                    <div class="flex justify-between items-end">
                                        <div>
                                            <div class="text-2xl font-bold text-gray-800">{{ number_format($item->warehouseIncome->sum('quantity')) }}</div>
                                            <div class="text-xs text-gray-500">Quantity</div>
                                        </div>
                                        <div class="text-right">
                                            <div class="text-2xl font-bold text-green-600">${{ number_format($item->warehouseIncome->sum('total'), 2) }}</div>
                                ...
                                <div class="bg-gradient-to-br from-red-50 to-rose-50 p-4 rounded-xl border border-red-100">
                                    ...
                                    <div class="flex justify-between items-end">
                                        <div>
                                            <div class="text-2xl font-bold text-gray-800">{{ number_format($item->warehouseOutcome->sum('quantity')) }}</div>
                                            <div class="text-xs text-gray-500">Quantity</div>
                                        </div>
                                        <div class="text-right">
                                            <div class="text-2xl font-bold text-red-600">${{ number_format($item->warehouseOutcome->sum('total'), 2) }}</div>
                                            <div class="text-xs text-gray-500">Total</div>
                                        </div>
                                    </div>
                                </div>
