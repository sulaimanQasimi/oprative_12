<div class="relative">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-green-50/50 via-white to-emerald-50/50 rounded-2xl blur-3xl">
    </div>
            ...
            @if($currentOrderId)
                    ...
                    <div class="mb-6 relative">
                        ...
                        @if($searchQuery && $showDropdown)
                                <div
                                    class="absolute z-50 w-full mt-2 bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-200/50 max-h-96 overflow-y-auto transform transition-all duration-300 ease-out">
