        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 account-card">
                <div class="p-6 flex flex-col items-center text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ __('Create New Sale') }}</h3>
                    <p class="text-gray-600 text-sm mb-4">{{ __('Add a new sales transaction to your profile') }}</p>
                    <button onclick="document.location=''" class="animate-button group relative px-4 py-2 text-sm font-medium leading-5 text-white transition-all duration-300 bg-gradient-to-r from-violet-500 via-purple-500 to-fuchsia-500 hover:from-violet-600 hover:via-purple-600 hover:to-fuchsia-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 overflow-hidden shadow-md hover:shadow-lg">
                        ...
                        <span class="relative">{{ __('Create Sale') }}</span>
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 account-card lg:col-span-2">
                <div class="p-6">
                    ...
                    <form id="filterForm" action="{{ route('customer.sales.index') }}" method="GET" class="grid gap-4 md:grid-cols-2">
                        <div>
                        ...
                        <div class="md:col-span-2 flex gap-3 mt-2">
                            ...
                            <a href="{{ route('customer.sales.index') }}" class="flex-1 px-4 py-2 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white text-sm font-medium rounded-md shadow focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-300">
