            ...
            <div class="flex">
                ...
                <div class="hidden sm:ml-8 sm:flex sm:space-x-8">
                    ...
                    <a href="{{ route('customer.sales') }}"
                       class="inline-flex items-center px-3 pt-1 border-b-2 transition-all duration-200 ease-in-out {{ request()->routeIs('customer.sales') ? 'border-blue-500 text-gray-900 scale-105' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 hover:scale-105' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 transition-transform group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
